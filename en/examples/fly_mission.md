...
> **Tip** The full source code for the example [can be found on Github here](https://github.com/dronecore/DroneCore/tree/v0.3.0/example/fly_mission).


[CMakeLists.txt](https://github.com/dronecore/DroneCore/blob/v0.3.0/example/fly_mission/CMakeLists.txt)
...
[fly_mission.cpp](https://github.com/dronecore/DroneCore/blob/v0.3.0/example/fly_mission/fly_mission.cpp)
